...
pub const BC7ENC_BLOCK_SIZE: u32 = 16;
pub const BC7ENC_MAX_PARTITIONS1: u32 = 64;
pub const BC7ENC_MAX_UBER_LEVEL: u32 = 4;
pub const BC7ENC_TRUE: u32 = 1;
pub const BC7ENC_FALSE: u32 = 0;
...
pub type bc7enc_bool = u8;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct bc7enc_compress_block_params {
    pub m_max_partitions_mode: u32,
    pub m_weights: [u32; 4usize],
    pub m_uber_level: u32,
    pub m_perceptual: bc7enc_bool,
    pub m_try_least_squares: bc7enc_bool,
    pub m_mode_partition_estimation_filterbank: bc7enc_bool,
    pub m_use_mode5_for_alpha: bc7enc_bool,
    pub m_use_mode7_for_alpha: bc7enc_bool,
}
#[test]
fn bindgen_test_layout_bc7enc_compress_block_params() {
    assert_eq!(
        ::std::mem::size_of::<bc7enc_compress_block_params>(),
        32usize,
        concat!("Size of: ", stringify!(bc7enc_compress_block_params))
    );
    assert_eq!(
        ::std::mem::align_of::<bc7enc_compress_block_params>(),
        4usize,
        concat!("Alignment of ", stringify!(bc7enc_compress_block_params))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_max_partitions_mode as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(bc7enc_compress_block_params),
            "::",
            stringify!(m_max_partitions_mode)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_weights as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(bc7enc_compress_block_params),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_uber_level as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(bc7enc_compress_block_params),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_perceptual as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(bc7enc_compress_block_params),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_try_least_squares as *const _ as usize },
        25usize,
        concat!(
            "Offset of field: ",
            stringify!(bc7enc_compress_block_params),
            "::",
            stringify!(m_try_least_squares)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_mode_partition_estimation_filterbank as *const _
                as usize
        },
        26usize,
        concat!(
            ...
            stringify!(bc7enc_compress_block_params),
            "::",
            stringify!(m_mode_partition_estimation_filterbank)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_use_mode5_for_alpha as *const _ as usize },
        27usize,
        concat!(
            "Offset of field: ",
            stringify!(bc7enc_compress_block_params),
            "::",
            stringify!(m_use_mode5_for_alpha)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<bc7enc_compress_block_params>())).m_use_mode7_for_alpha as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(bc7enc_compress_block_params),
            "::",
            stringify!(m_use_mode7_for_alpha)
        )
    );
}
extern "C" {
    pub fn bc7enc_compress_block_init();
}
extern "C" {
    pub fn bc7enc_compress_block(
        pBlock: *mut ::std::os::raw::c_void,
        pPixelsRGBA: *const ::std::os::raw::c_void,
        pComp_params: *const bc7enc_compress_block_params,
    ) -> bc7enc_bool;
}
